  ...
  return (
    <main className="p-8 max-w-4xl mx-auto">
      ...
      <div className="text-center mb-10">
        ...
        <p className="mt-4 text-lg text-slate-600 dark:text-slate-400">by {novel.author}</p>
      </div>
      ...
      <div className="mb-12">
        <div className="flex justify-center gap-4 mb-6">
          ...
          <span className="bg-slate-200 text-slate-700 text-sm font-medium px-3 py-1 rounded-full dark:bg-slate-700 dark:text-slate-200">Date: {novel.date}</span>
        </div>
      ...
      {/* Chapter List */}
      <div>
        <h2 className="text-2xl font-bold mb-4 text-center text-slate-900 dark:text-slate-100">Table of Contents</h2>
